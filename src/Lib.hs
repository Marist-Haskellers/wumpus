        ...
        Nothing -> do
            ...
            case choice of
                ...
                ChoiceSense -> do
                    ...
                    let senseString = if sense `elem` sensed 
                        then "You have a strong sense of " ++ show sense 
                        else "You do not " ++ show sense ++ " anyting"
                    output senseString
                    oneLoop gameState
                ChoiceShoot -> do
